...
public class FormChangePasswordDocGia extends JFrame {
	...
	private FormChangePasswordDocGia thisForm = this;
	
	/**
	 * Create the frame.
	 */
	public FormChangePasswordDocGia(String username) {
	...
	private void createContents() {
		...
		labelUsername.setIcon(new ImageIcon(FormChangePasswordDocGia.class.getResource("/icons/user.png")));
